...
def chk():
  ...
  #print (' \033[1;31m ايديك غير مفعل ارسل الايدي الخاص بك للمطور للتفعيل\n')
  #print('\r        الاداة مدفوعة للتفعيل مراسلة المطور\n')
  
  id = "10"
  #print("\x1b[37;1mالادات غير فعاله : ")
  
  try: 
    httpCaht = requests.get("https://pastebin.com/raw/5SATnZhi").text
    if id in httpCaht:
      #print("\033[1;92mتم تفعيل ادات")
      msg = str(os.geteuid())
      time.sleep(2)
      pass
    else:
        
      print("\033[0;96mعزيزي الاداة مدفوع اصبح متفوعه وفعيل عن طريق المبرمج حسين علي          @H0773") 
...
def passwrd():
	print(f"\x1b[1;97m------------------------------------------------------------")
	print(f' \033[1;92mHUSSEIN ALI ')
	print('\022[1;82 py H0773  / MR_HC6')
	print(f"\x1b[1;97m------------------------------------------------------------")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r •Hussein Ali• {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
